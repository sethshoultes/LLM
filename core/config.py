...
# Path is used by type annotations, not directly
...
class Config:
    ...
    def parse_args(self, args: Optional[List[str]] = None) -> None:
        ...
        parser.add_argument(
            "--no-smart-context", action="store_true", help="Disable smart context management"
        )
    ...
    def _update_env_vars(self) -> None:
        ...
        os.environ["LLAMA_CPP_VERBOSE"] = (
            "1" if self._config.get("llama_cpp_verbose", False) else "0"
        )
