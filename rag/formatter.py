...
class ContextFormatter:
    ...
    def format_document(self,
                      ...
                      allocated_tokens: int = 0) -> Tuple[str, int]:
        """
        ...
        # Format content
        if available_for_content > 0 and token_manager.estimate_tokens(content) > available_for_content:
    ...
    def format_documents(self,
                       ...
                       allocated_tokens: Dict[str, int] = None) -> Tuple[str, List[Dict[str, Any]]]:
        """
        ...
        for doc in documents:
            ...
            document_metadata.append({
                ...
                "truncated": tokens_used < token_manager.estimate_tokens(doc.get("content", ""))
            })
