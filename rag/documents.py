...
class Document:
    ...
    def from_file(cls, file_path: Union[str, Path]) -> "Document":
        ...
        return cls(id=doc_id, title=title, content=content_text, **metadata_copy)
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Document":
        ...
        # Create document instance
        return cls(id=doc_id, title=title, content=content, **metadata)

    @classmethod
    def create(
        cls, title: str, content: str, tags: Optional[List[str]] = None, **kwargs
    ) -> "Document":
        """
...
def create_document(
    title: str, content: str, tags: Optional[List[str]] = None, **kwargs
) -> Document:
    """Create a new document."""
