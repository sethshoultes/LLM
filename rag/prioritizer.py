...
class DocumentPrioritizer:
    ...
    def prioritize_documents(self,
                          ...
                          max_documents: int = DEFAULT_MAX_RESULTS) -> List[Dict[str, Any]]:
        """
        ...
        prioritized = sorted(docs, key=lambda d: d.get("priority_score", d.get("score", 0)), reverse=True)
        
        # Limit to max documents
        return prioritized[:max_documents]
    
    def _apply_query_analysis(self,
                           documents: List[Dict[str, Any]],
    ...
    def _apply_history_analysis(self,
                             documents: List[Dict[str, Any]],
        ...
        for doc in documents:
            ...
            normalized_relevance = relevance_score / max_possible_score if max_possible_score > 0 else 0
    ...
    def _apply_diversity_promotion(self,
    ...
    def _diversify_by_content(self,
                           documents: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def _extract_terms(self, text: str) -> List[str]:
        ...
        stop_words = {
            ...
            'it', 'as', 'be', 'they', 'their', 'have', 'has', 'had', 'do', 'does'
        }
