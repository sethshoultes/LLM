...
try:
    ...
    logger.warning("Could not import hybrid_search module. Semantic and hybrid search will not be available.")
...
class RagApiHandler:
        ...
        if parts[0] == 'projects':
            if len(parts) == 1:
                ...
                if search_type == 'hybrid' and HAS_HYBRID_SEARCH:
                    ...
                    return self._hybrid_search_documents(project_id, query, semantic_weight, keyword_weight)
    ...
    def _hybrid_search_documents(self, project_id: str, query: str, 
                              semantic_weight: float = 0.6, 
                              keyword_weight: float = 0.4) -> Tuple[int, Dict[str, Any]]:
    ...
    def _estimate_tokens(self, data: Dict[str, Any]) -> Tuple[int, Dict[str, Any]]:
        ...
        try:
            ...
            if HAS_RAG_MODULES:
                ...
                context_window = rag_token_manager.get_context_window(model_id=None, model_path=model_path)
            ...
            meta = {
                ...
                "estimation_method": "token_manager" if HAS_RAG_MODULES else "character-based-approximation"
            }
