...
class ProjectManager:
            ...
            for project_dir in project_dirs:
                ...
                if project_file.exists():
                    try:
                        ...
                        logger.error(f"Error reading project {project_dir.name}: {e}", exc_info=True)
                else:
    ...
    def update_document(self, project_id: str, doc_id: str, 
        ...
        try:
            ...
            if project_id in self.search_engines and (content is not None or title is not None or tags is not None):
    ...
    def search_documents(self, project_id: str, query: str, 
                        tags: List[str] = None, max_results: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    def _update_project_counts(self, project_id: str) -> None:
        ...
        try:
            ...
            logger.debug(f"Updated project counts for {project_id}: {document_count} documents, {chat_count} chats, {artifact_count} artifacts")
        except Exception as e:
