...
class HybridSearch:
    ...
    def load_document_embeddings(self, project_id: str) -> Dict[str, np.ndarray]:
        ...
        if (
            cache_key in self.embeddings_cache and 
    ...
    def _save_embeddings_to_cache(self, project_id: str, embeddings: Dict[str, np.ndarray]):
        ...
        try:
            ...
            metadata = {
                ...
                "embedding_dim": embeddings[next(iter(embeddings))].shape[0] if embeddings else DEFAULT_EMBEDDING_DIM,
    ...
    @timer
    def semantic_search(self, project_id: str, query: str, 
    ...
    @timer
    def hybrid_search(self, project_id: str, query: str, 
